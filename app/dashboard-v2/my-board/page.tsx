...
import MyBoardKanban, { buildMyBoardCards } from "./_components/MyBoardKanban";
import { ClipboardList } from "lucide-react";
import Link from "next/link";

export default async function V2MyBoardPage() {
    ...
    <div className="space-y-4">
      <header className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
        <div>
          <Link
            href="/dashboard-v2"
            className="text-xs font-semibold text-blue-300 hover:text-white mb-2 inline-block"
          >
            ← V2 테스트 보드로
          </Link>
