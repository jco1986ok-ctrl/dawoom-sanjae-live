...
const COLUMN_MISSING =
  /pdf_url|docs_status|has_weim|other_docs|referrer|assigned_to|disease_category|fee_amount|current_owner_role|assigned_user_id|assignment_memo|is_read|column|does not exist|schema cache|could not find/i;
