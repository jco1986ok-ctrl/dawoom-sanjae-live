...
export const LEADS_LIST_SELECT_CORE =
  "id, customer_name, phone, disease_name, disease_category, fee_amount, consultation_status, current_owner_role, assigned_user_id, assignment_memo, is_read, created_at, referral_source, notes" as const;
